...
public class InteractableWater : MonoBehaviour
{
    ...
    [SerializeField, Range(0f, 10f)] private float _speedMult = 5.5f;
    ...
    public void ResetEdgeCollider()
    {
        ...
        Vector2 secondPoint = new Vector2(_vertices[_topVerticesIndex.Length - 1].x, _vertices[_topVerticesIndex[_topVerticesIndex.Length - 1]].y);
...
public class InteracableWaterEditor : Editor
{
    ...
    private void ChangeDimensions(ref float width, ref float height, float calcaulatedWidthMax, float calculatedheightMax)
    {
        width = Mathf.Max(0, 1f, calcaulatedWidthMax);
    ...
    private void OnSceneGUI()
    {
        ...
        // Handle size for width and height
